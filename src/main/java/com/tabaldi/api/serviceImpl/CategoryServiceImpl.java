...
public class CategoryServiceImpl implements CategoryService {
    ...
    public Category saveCategoryInfo(CategoryPayload payload) throws TabaldiGenericException {
        ...
        // NOTE it should not be updatable but kept for any changes in future that makes it updatable
        ...
        if(payload.getCategoryId()!=null){
            ...
            if (!categoryOptional.isPresent()){
                ...
                String changeNotAllowedMessage = MessagesUtils.getNotChangeUserMessage(messageSource,"Category", "نوع المنتج");
...
//                String categoryUpdateMessage = messageSource.getMessage("error.category.update", null, LocaleContextHolder.getLocale());
//                throw new TabaldiGenericException(HttpServletResponse.SC_BAD_REQUEST, categoryUpdateMessage);
    ...
    public Boolean deleteCategoryById(Long categoryId) throws TabaldiGenericException {
        ...
        if(productRepository.countByCategory(categoryId)!=0) {
            String categoryUpdateMessage = messageSource.getMessage("error.category.has.product", null, LocaleContextHolder.getLocale());
            throw new TabaldiGenericException(HttpServletResponse.SC_BAD_REQUEST, categoryUpdateMessage);
        }else {
