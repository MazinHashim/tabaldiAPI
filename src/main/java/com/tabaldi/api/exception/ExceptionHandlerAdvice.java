...
public class ExceptionHandlerAdvice {
    ...
    public @ResponseBody CustomErrorResponse handleNoSuchElementExceptions(HttpServletResponse response,
                                                         NoSuchElementException exception) {
        System.out.println("No Such Element Exception "+(exception instanceof NoSuchElementException));
        String message = MessagesUtils.getNotFoundMessage(messageSource,"Data", "البيانات");
        return getCustomErrorResponse(response, message, HttpServletResponse.SC_NO_CONTENT);
    }
    ...
    public @ResponseBody CustomErrorResponse handleValidationExceptions(HttpServletResponse response,
        ...
        CustomErrorResponse errorResponse = new CustomErrorResponse(response);
        System.out.println("Method Argument Not Valid Exception "+(exception instanceof MethodArgumentNotValidException));
        String message = "";
    ...
    public @ResponseBody CustomErrorResponse handleDataIntegrityViolationExceptions(HttpServletResponse response,
        ...
        System.out.println("Data Integrity Violation Exception "+(exception instanceof DataIntegrityViolationException)
