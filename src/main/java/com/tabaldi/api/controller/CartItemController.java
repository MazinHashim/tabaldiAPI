...
public class CartItemController {
        ...
        public @ResponseBody ResponseEntity<CartItemListResponse> updateQuantityById(
                ...
                List<CartItem> updateCarts = cartItemService.updateQuantityById(payload.getCartItemId(),
                                payload.getNewQuantity());
                String successFetchMessage = MessagesUtils.getSavedDataMessage(messageSource, "CartItem", "عنصر السلة",
                                "updated", "تعديل");
        ...
        public @ResponseBody ResponseEntity<CartItemListResponse> deleteCartItem(
