...
//                                .accessDeniedHandler(customAccessDeniedHandler))
                ...
                .authorizeHttpRequests(authorizationManagerRequestMatcherRegistry ->
                        authorizationManagerRequestMatcherRegistry
                                ...
                                .requestMatchers("/api/v1/vendors/*/advertisements").hasAnyRole(Role.SUPERADMIN.name(),Role.VENDOR.name(), Role.CUSTOMER.name())
                                ...
                                .requestMatchers("/api/v1/advertisements/active").hasAnyRole(Role.VENDOR.name(), Role.CUSTOMER.name(), Role.SUPERADMIN.name())
