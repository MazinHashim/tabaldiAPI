...
//                                .accessDeniedHandler(customAccessDeniedHandler))
                ...
                .authorizeHttpRequests(authorizationManagerRequestMatcherRegistry ->
                        authorizationManagerRequestMatcherRegistry
                                ...
                                .requestMatchers("/api/v1/users/verify/changePhone/**").hasAnyRole(Role.CUSTOMER.name())
                                ...
                                .requestMatchers("/api/v1/orders/pending").hasAnyRole(Role.SUPERADMIN.name())
                                .requestMatchers("/api/v1/orders/create/**").hasAnyRole(Role.CUSTOMER.name())
                                .requestMatchers("/api/v1/orders/history").hasAnyRole(Role.CUSTOMER.name(), Role.SUPERADMIN.name())
                                ...
                                .requestMatchers("/api/v1/invoices/*/download").permitAll()
                                ...
                                .requestMatchers("/api/v1/products/toggle/publish/*").hasAnyRole(Role.SUPERADMIN.name())
                                .requestMatchers("/api/v1/products/search").permitAll()
                                .requestMatchers("/api/v1/products/*").permitAll()
                                .requestMatchers("/api/v1/products/save").hasAnyRole(Role.VENDOR.name(), Role.SUPERADMIN.name())
                                .requestMatchers("/api/v1/products/delete/*").hasAnyRole(Role.VENDOR.name(), Role.SUPERADMIN.name())
                                ...
                                .requestMatchers("/api/v1/vendors/*/products").permitAll()
                                .requestMatchers("/api/v1/vendors/toggle/working/*").hasAnyRole(Role.SUPERADMIN.name())
                                .requestMatchers("/api/v1/vendors/*/categories").hasAnyRole(Role.SUPERADMIN.name(),Role.VENDOR.name(), Role.CUSTOMER.name())
                                .requestMatchers("/api/v1/vendors/*/advertisements").hasAnyRole(Role.SUPERADMIN.name(),Role.VENDOR.name())
                                ...
                                .requestMatchers("/api/v1/advertisements").hasAnyRole(Role.SUPERADMIN.name())
                                .requestMatchers("/api/v1/advertisements/active").permitAll()
                                .requestMatchers("/api/v1/advertisements/toggle/showing/*").hasAnyRole(Role.SUPERADMIN.name())
                                .requestMatchers("/api/v1/advertisements/save").hasAnyRole(Role.SUPERADMIN.name())
                                .requestMatchers("/api/v1/advertisements/delete/*").hasAnyRole(Role.SUPERADMIN.name())
                                .requestMatchers("/api/v1/advertisements/*").hasAnyRole(Role.SUPERADMIN.name())
                                .anyRequest().denyAll()
                )
